...
void main() => runApp(ForFunPage());

class ForFunPage extends StatefulWidget{
  ForFunPage({Key key}) : super(key: key);
  @override
  _ForFunPageState createState() => new _ForFunPageState();

}

class _ForFunPageState extends State<ForFunPage> {
  @override
  void initState() {
    super.initState();
    sum = fetchSummoner();
